...
// ==========================
$('#tmNav').singlePageNav({
    'filter': ':not([href="/products.html"]):not([href="/about.html"])',
    'easing': 'easeInOutExpo',
    'speed': 600
});

$("a").on('click', function(event) {
    // استثناء رابط المنتجات و About Us
    if ($(this).attr('href') === "/products/html/products.html" || $(this).attr('href') === "/HTML/about.html") return true;
